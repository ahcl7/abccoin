...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Abccoin: starting difficulty is 1 / 2^12
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Abccoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Abccoin: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Abccoin: increase each by adding 2 to bitcoin's value.
