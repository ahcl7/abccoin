...
#if defined(NDEBUG)
# error "Wtfcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x5e1b6f90dcf1ebfabf0056fc373f0171aa08740c32683a290e1b0471a9dbcd01");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Wtfcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Wtfcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Wtfcoin: 2.5 minutes
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Wtfcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9a6646930fc9f46d75ef4a2881d0c2aba2f4b885325f2d016494c8b966e84021");
    }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Wtfcoin: increase each by adding 2 to bitcoin's value.
...
void static WtfcoinMiner(CWallet *pwallet)
{
    printf("WtfcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("wtfcoin-miner");
    ...
    try { loop {
        ...
        printf("Running WtfcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("WtfcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&WtfcoinMiner, pwallet));
}
